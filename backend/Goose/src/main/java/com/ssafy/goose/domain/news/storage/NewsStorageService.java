...
public class NewsStorageService {
    ...
    public NewsStorageService(NewsRepository newsRepository, NewsBiasAnalysisService newsBiasAnalysisService) {
    ...
    public void saveNewsToMongoDB(Map<String, Object> newsData, String keyword) {
        ...
        for (Map<String, Object> item : newsItems) {
            String content = (String) item.get("description"); // 본문 데이터
